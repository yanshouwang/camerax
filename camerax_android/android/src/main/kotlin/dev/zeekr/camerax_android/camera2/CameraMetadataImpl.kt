...
val Int.cameraMetadataInfoSupportedHardwareLevelApi: CameraMetadataInfoSupportedHardwareLevelApi
    get() = when (this) {
...
val Int.cameraMetadataControlModeApi: CameraMetadataControlModeApi
    get() = when (this) {
...
val Int.cameraMetadataControlAeModeApi: CameraMetadataControlAeModeApi
    get() = when (this) {
...
val Int.cameraMetadataControlAfModeApi: CameraMetadataControlAfModeApi
    get() = when (this) {
...
val Int.cameraMetadataControlAwbModeApi: CameraMetadataControlAwbModeApi
    get() = when (this) {
