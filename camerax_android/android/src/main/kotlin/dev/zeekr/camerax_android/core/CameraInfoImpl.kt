...
import dev.zeekr.camerax_android.common.IntLiveData
import dev.zeekr.camerax_android.common.IntRange
import dev.zeekr.camerax_android.common.LowLightBoostStateLiveData
...
class CameraInfoImpl(registrar: CameraXApiPigeonProxyApiRegistrar) :
    ...
    override fun getTorchStrengthLevel(pigeon_instance: CameraInfo): IntLiveData {
        return IntLiveData(pigeon_instance.torchStrengthLevel)
    }
    ...
    override fun getLowLightBoostState(pigeon_instance: CameraInfo): LowLightBoostStateLiveData {
        return LowLightBoostStateLiveData(pigeon_instance.lowLightBoostState)
    }
