...
import dev.zeekr.camerax_android.PigeonApiRecordingStatsProxyApi

class RecordingStatsImpl(registrar: CameraXApiPigeonProxyApiRegistrar) : PigeonApiRecordingStatsProxyApi(registrar) {
