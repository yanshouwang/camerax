...
private class CameraXApiPigeonProxyApiBaseCodec(val registrar: CameraXApiPigeonProxyApiRegistrar) : CameraXApiPigeonCodec() {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?) {
    ...
    if (value is dev.zeekr.camerax_android.common.PermissionManager) {
...
abstract class PigeonApiCameraStateLiveDataApi(open val pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar) {
  ...
  abstract fun observe(pigeon_instance: dev.zeekr.camerax_android.common.CameraStateLiveData, observer: dev.zeekr.camerax_android.common.CameraStateObserver)
...
abstract class PigeonApiTorchStateLiveDataApi(open val pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar) {
  ...
  abstract fun observe(pigeon_instance: dev.zeekr.camerax_android.common.TorchStateLiveData, observer: dev.zeekr.camerax_android.common.TorchStateObserver)
...
abstract class PigeonApiZoomStateLiveDataApi(open val pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar) {
  ...
  abstract fun observe(pigeon_instance: dev.zeekr.camerax_android.common.ZoomStateLiveData, observer: dev.zeekr.camerax_android.common.ZoomStateObserver)
...
abstract class PigeonApiMlKitAnalyzerApi(open val pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar) {
  abstract fun pigeon_defaultConstructor(detectors: List<dev.zeekr.camerax_android.ml.Detector>, targetCoordinateSystem: CoordinateSystemApi, consumer: dev.zeekr.camerax_android.common.MlKitAnalyzerResultConsumer): androidx.camera.mlkit.vision.MlKitAnalyzer
...
abstract class PigeonApiCameraControllerApi(open val pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar) {
  ...
  abstract fun getTorchState(pigeon_instance: androidx.camera.view.CameraController, callback: (Result<dev.zeekr.camerax_android.common.TorchStateLiveData>) -> Unit)
  ...
  abstract fun getZoomState(pigeon_instance: androidx.camera.view.CameraController, callback: (Result<dev.zeekr.camerax_android.common.ZoomStateLiveData>) -> Unit)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as androidx.camera.view.CameraController
            api.getTorchState(pigeon_instanceArg) { result: Result<dev.zeekr.camerax_android.common.TorchStateLiveData> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(CameraXApiPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as androidx.camera.view.CameraController
            api.getZoomState(pigeon_instanceArg) { result: Result<dev.zeekr.camerax_android.common.ZoomStateLiveData> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(CameraXApiPigeonUtils.wrapError(error))
              } else {
