  ...
  fun pigeon_newInstance(pigeon_instanceArg: dev.hebei.camerax_android.legacy.common.CameraStateObserver.Impl, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              CameraXError("new-instance-error", "Attempting to create a new Dart instance of CameraStateObserver, but the class has a nonnull callback method.", "")))
    }
  }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: dev.hebei.camerax_android.legacy.common.TorchStateObserver.Impl, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              CameraXError("new-instance-error", "Attempting to create a new Dart instance of TorchStateObserver, but the class has a nonnull callback method.", "")))
    }
  }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: dev.hebei.camerax_android.legacy.common.ZoomStateObserver.Impl, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              CameraXError("new-instance-error", "Attempting to create a new Dart instance of ZoomStateObserver, but the class has a nonnull callback method.", "")))
    }
  }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: androidx.camera.core.resolutionselector.ResolutionFilter, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              CameraXError("new-instance-error", "Attempting to create a new Dart instance of ResolutionFilter, but the class has a nonnull callback method.", "")))
    }
  }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: androidx.camera.core.ImageAnalysis.Analyzer, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              CameraXError("new-instance-error", "Attempting to create a new Dart instance of ImageAnalyzer, but the class has a nonnull callback method.", "")))
    }
  }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: androidx.camera.core.ImageAnalysis.Analyzer, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              CameraXError("new-instance-error", "Attempting to create a new Dart instance of JpegAnalyzer, but the class has a nonnull callback method.", "")))
    }
  }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.google.mlkit.vision.barcode.ZoomSuggestionOptions.ZoomCallback, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              CameraXError("new-instance-error", "Attempting to create a new Dart instance of ZoomCallback, but the class has a nonnull callback method.", "")))
    }
  }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: dev.hebei.camerax_android.legacy.common.MlKitAnalyzerResultConsumer.Impl, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              CameraXError("new-instance-error", "Attempting to create a new Dart instance of MlKitAnalyzerResultConsumer, but the class has a nonnull callback method.", "")))
    }
  }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: dev.hebei.camerax_android.legacy.common.VideoRecordEventConsumer.Impl, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              CameraXError("new-instance-error", "Attempting to create a new Dart instance of VideoRecordEventConsumer, but the class has a nonnull callback method.", "")))
    }
  }
