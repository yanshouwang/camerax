...
import dev.hebei.camerax_android.legacy.args

class AudioStats(registrar: CameraXRegistrar) : PigeonApiAudioStats(registrar) {
    override fun getAudioAmplitude(pigeon_instance: androidx.camera.video.AudioStats): Double {
        return pigeon_instance.audioAmplitude
    }

    override fun getAudioState(pigeon_instance: androidx.camera.video.AudioStats): AudioState {
        return pigeon_instance.audioState.audioStateArgs
    }

    override fun getErrorCause(pigeon_instance: androidx.camera.video.AudioStats): List<Any?>? {
