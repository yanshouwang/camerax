...
class ImageInfo(registrar: CameraXRegistrar) : PigeonApiImageInfo(registrar) {
    override fun getTimestamp(pigeon_instance: androidx.camera.core.ImageInfo): Long {
        return pigeon_instance.timestamp
    }

    override fun getRotationDegrees(pigeon_instance: androidx.camera.core.ImageInfo): Long {
