...
class PigeonOverrides {
  ...
  static ResolutionSelectorApi Function({
    required ResolutionModeApi allowedResolutionMode,
  ...
  /// Overrides [ZoomCallbackApi.new].
  static ZoomCallbackApi Function(
      {required bool Function(
        ZoomCallbackApi pigeon_instance,
        double zoomRatio,
      ) setZoom})? zoomCallbackApi_new;
...
class ZoomCallbackApi extends PigeonInternalProxyApiBaseClass {
  factory ZoomCallbackApi({
    ...
    if (PigeonOverrides.zoomCallbackApi_new != null) {
      return PigeonOverrides.zoomCallbackApi_new!(setZoom: setZoom);
    }
    return ZoomCallbackApi.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      setZoom: setZoom,
    );
