...
abstract class CameraViewPigeon extends PlatformInterface {
  ...
  Future<void> create(String id, {required CameraViewArguments arguments});
...
class _CameraViewPigeon extends CameraViewPigeon {
  ...
  @override
  Future<void> create(String id, {required CameraViewArguments arguments}) {
    final argumentsByteArray = arguments.writeToBuffer();
    return hostPigeon.create(id, argumentsByteArray);
  }

  @override
  Future<void> dispose(String id) {
    return hostPigeon.dispose(id);
  }
}
