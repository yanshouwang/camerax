  ...
  static void setup(MLAnalyzerFlutterPigeon? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          final Uint8List? arg_mlMetadataBuffer = (args[1] as Uint8List?);
          assert(arg_mlMetadataBuffer != null, 'Argument for dev.flutter.pigeon.MLAnalyzerFlutterPigeon.onAnalyzed was null, expected non-null Uint8List.');
          api.onAnalyzed(arg_id!, arg_mlMetadataBuffer!);
          return;
        });
      }
    }
