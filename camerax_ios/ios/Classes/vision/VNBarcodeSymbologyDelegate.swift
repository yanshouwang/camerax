...
extension VNBarcodeSymbology {
    var api: VNBarcodeSymbologyApi {
        get throws {
            ...
            throw CameraXError(code: "argument-error", message: "unknown symbology: \(self)", details: nil)
        }
    }
}
...
extension VNBarcodeSymbologyApi {
    var delegate: VNBarcodeSymbology {
        get throws {
            ...
            throw CameraXError(code: "unsupported-error", message: "\(self) is unavailable", details: nil)
        }
    }
}
