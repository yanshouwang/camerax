...
final class PigeonApiAVMetadataBodyObjectProxyApi: PigeonApiProtocolAVMetadataBodyObjectProxyApi  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiAVMetadataBodyObjectProxyApi?) {
    ...
    if #available(iOS 13.0.0, *) {
      ...
      let getBodyIDChannel = FlutterBasicMessageChannel(
        name: "dev.flutter.pigeon.camerax_ios.AVMetadataBodyObjectProxyApi.getBodyID",
        binaryMessenger: binaryMessenger, codec: codec)
      if api != nil {
        getBodyIDChannel.setMessageHandler { message, reply in
          reply(wrapError(FlutterError(code: "PigeonUnsupportedOperationError",
                                       message: "Call to getBodyID requires @available(iOS 13.0.0, *).",
                                       details: nil
                                      )))
        }
      } else {
