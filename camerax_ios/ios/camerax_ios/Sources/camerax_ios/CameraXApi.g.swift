...
protocol CameraXApiPigeonProxyApiDelegate {
  ...
  /// An implementation of [PigeonApiAVMetadataCatHeadObjectProxyApi] used to add a new Dart instance of
  /// `AVMetadataCatHeadObjectProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  func pigeonApiAVMetadataCatHeadObjectProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiAVMetadataCatHeadObjectProxyApi
  /// An implementation of [PigeonApiAVMetadataDogHeadObjectProxyApi] used to add a new Dart instance of
  /// `AVMetadataDogHeadObjectProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  func pigeonApiAVMetadataDogHeadObjectProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiAVMetadataDogHeadObjectProxyApi
  ...
  /// `CameraStateLiveDataProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `TorchStateLiveDataProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `ZoomStateLiveDataProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `PreviewViewStreamStateLiveDataProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `PreviewViewStreamStateObserverProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiUIViewProxyApi] used to add a new Dart instance of
  /// `UIViewProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `ResolutionSelectorBuilderProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `CameraSelectorBuilderProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `FocusMeteringActionBuilderProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `FileOutputOptionsBuilderProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `VideoRecordEventStatusProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `VideoRecordEventStartProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `VideoRecordEventPauseProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `VideoRecordEventResumeProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// `VideoRecordEventFinalizeProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNImageRequestHandlerProxyApi] used to add a new Dart instance of
  /// `VNImageRequestHandlerProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNRequestProxyApi] used to add a new Dart instance of
  /// `VNRequestProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  func pigeonApiVNRequestProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiVNRequestProxyApi
  /// An implementation of [PigeonApiVNImageBasedRequestProxyApi] used to add a new Dart instance of
  /// `VNImageBasedRequestProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNObservationProxyApi] used to add a new Dart instance of
  /// `VNObservationProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  func pigeonApiVNObservationProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiVNObservationProxyApi
  /// An implementation of [PigeonApiVNDetectedObjectObservationProxyApi] used to add a new Dart instance of
  /// `VNDetectedObjectObservationProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNRectangleObservationProxyApi] used to add a new Dart instance of
  /// `VNRectangleObservationProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNDetectBarcodesRequestProxyApi] used to add a new Dart instance of
  /// `VNDetectBarcodesRequestProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNBarcodeObservationProxyApi] used to add a new Dart instance of
  /// `VNBarcodeObservationProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNDetectFaceRectanglesRequestProxyApi] used to add a new Dart instance of
  /// `VNDetectFaceRectanglesRequestProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNFaceLandmarkRegionProxyApi] used to add a new Dart instance of
  /// `VNFaceLandmarkRegionProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNFaceLandmarkRegion2DProxyApi] used to add a new Dart instance of
  /// `VNFaceLandmarkRegion2DProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  ...
  /// An implementation of [PigeonApiVNFaceLandmarksProxyApi] used to add a new Dart instance of
  /// `VNFaceLandmarksProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  func pigeonApiVNFaceLandmarksProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiVNFaceLandmarksProxyApi
  /// An implementation of [PigeonApiVNFaceLandmarks2DProxyApi] used to add a new Dart instance of
  /// `VNFaceLandmarks2DProxyApi` to the Dart `InstanceManager` and make calls to Dart.
  func pigeonApiVNFaceLandmarks2DProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiVNFaceLandmarks2DProxyApi
  /// An implementation of [PigeonApiVNFaceObservationProxyApi] used to add a new Dart instance of
  /// `VNFaceObservationProxyApi` to the Dart `InstanceManager` and make calls to Dart.
...
extension CameraXApiPigeonProxyApiDelegate {
  func pigeonApiAVMetadataCatHeadObjectProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiAVMetadataCatHeadObjectProxyApi {
    return PigeonApiAVMetadataCatHeadObjectProxyApi(pigeonRegistrar: registrar, delegate: PigeonApiDelegateAVMetadataCatHeadObjectProxyApi())
  }
  func pigeonApiAVMetadataDogHeadObjectProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiAVMetadataDogHeadObjectProxyApi {
    return PigeonApiAVMetadataDogHeadObjectProxyApi(pigeonRegistrar: registrar, delegate: PigeonApiDelegateAVMetadataDogHeadObjectProxyApi())
  }
  func pigeonApiAVMetadataCatBodyObjectProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiAVMetadataCatBodyObjectProxyApi {
    return PigeonApiAVMetadataCatBodyObjectProxyApi(pigeonRegistrar: registrar, delegate: PigeonApiDelegateAVMetadataCatBodyObjectProxyApi())
  }
  func pigeonApiAVMetadataDogBodyObjectProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiAVMetadataDogBodyObjectProxyApi {
    return PigeonApiAVMetadataDogBodyObjectProxyApi(pigeonRegistrar: registrar, delegate: PigeonApiDelegateAVMetadataDogBodyObjectProxyApi())
  }
  func pigeonApiAVMetadataHumanBodyObjectProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiAVMetadataHumanBodyObjectProxyApi {
    return PigeonApiAVMetadataHumanBodyObjectProxyApi(pigeonRegistrar: registrar, delegate: PigeonApiDelegateAVMetadataHumanBodyObjectProxyApi())
  }
  func pigeonApiAVMetadataHumanFullBodyObjectProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiAVMetadataHumanFullBodyObjectProxyApi {
    return PigeonApiAVMetadataHumanFullBodyObjectProxyApi(pigeonRegistrar: registrar, delegate: PigeonApiDelegateAVMetadataHumanFullBodyObjectProxyApi())
  }
  func pigeonApiAVMetadataSalientObjectProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiAVMetadataSalientObjectProxyApi {
    return PigeonApiAVMetadataSalientObjectProxyApi(pigeonRegistrar: registrar, delegate: PigeonApiDelegateAVMetadataSalientObjectProxyApi())
  }
  func pigeonApiCloseableProxyApi(_ registrar: CameraXApiPigeonProxyApiRegistrar) -> PigeonApiCloseableProxyApi {
...
open class CameraXApiPigeonProxyApiRegistrar {
  ...
  func setUp() {
    ...
    PigeonApiAVMetadataObjectProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiAVMetadataObjectProxyApi(self))
    PigeonApiAVMetadataBodyObjectProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiAVMetadataBodyObjectProxyApi(self))
    PigeonApiAVMetadataFaceObjectProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiAVMetadataFaceObjectProxyApi(self))
    PigeonApiAVMetadataMachineReadableCodeObjectProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiAVMetadataMachineReadableCodeObjectProxyApi(self))
    PigeonApiAVAnalyzerResultProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiAVAnalyzerResultProxyApi(self))
    ...
    PigeonApiCameraStateLiveDataProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiCameraStateLiveDataProxyApi(self))
    ...
    PigeonApiTorchStateLiveDataProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiTorchStateLiveDataProxyApi(self))
    ...
    PigeonApiZoomStateLiveDataProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiZoomStateLiveDataProxyApi(self))
    ...
    PigeonApiPreviewViewStreamStateLiveDataProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiPreviewViewStreamStateLiveDataProxyApi(self))
    PigeonApiPreviewViewStreamStateObserverProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiPreviewViewStreamStateObserverProxyApi(self))
    ...
    PigeonApiUIViewProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiUIViewProxyApi(self))
    ...
    PigeonApiResolutionSelectorBuilderProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiResolutionSelectorBuilderProxyApi(self))
    ...
    PigeonApiCameraSelectorBuilderProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiCameraSelectorBuilderProxyApi(self))
    ...
    PigeonApiFocusMeteringActionBuilderProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiFocusMeteringActionBuilderProxyApi(self))
    ...
    PigeonApiFileOutputOptionsBuilderProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiFileOutputOptionsBuilderProxyApi(self))
    ...
    PigeonApiVNImageRequestHandlerProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNImageRequestHandlerProxyApi(self))
    PigeonApiVNRequestProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNRequestProxyApi(self))
    PigeonApiVNImageBasedRequestProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNImageBasedRequestProxyApi(self))
    PigeonApiVNObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNObservationProxyApi(self))
    PigeonApiVNDetectedObjectObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNDetectedObjectObservationProxyApi(self))
    PigeonApiVNRectangleObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNRectangleObservationProxyApi(self))
    PigeonApiVNDetectBarcodesRequestProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNDetectBarcodesRequestProxyApi(self))
    PigeonApiVNBarcodeObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNBarcodeObservationProxyApi(self))
    PigeonApiVNDetectFaceRectanglesRequestProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNDetectFaceRectanglesRequestProxyApi(self))
    PigeonApiVNFaceLandmarkRegionProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNFaceLandmarkRegionProxyApi(self))
    PigeonApiVNFaceLandmarkRegion2DProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNFaceLandmarkRegion2DProxyApi(self))
    PigeonApiVNFaceLandmarksProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNFaceLandmarksProxyApi(self))
    PigeonApiVNFaceLandmarks2DProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNFaceLandmarks2DProxyApi(self))
    PigeonApiVNFaceObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiVNFaceObservationProxyApi(self))
  }
  func tearDown() {
    CameraXApiPigeonInstanceManagerApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, instanceManager: nil)
    PigeonApiAVMetadataObjectProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiAVMetadataBodyObjectProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiAVMetadataFaceObjectProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiAVMetadataMachineReadableCodeObjectProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiAVAnalyzerResultProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    ...
    PigeonApiCameraStateLiveDataProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiCameraStateObserverProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiTorchStateLiveDataProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiTorchStateObserverProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiZoomStateLiveDataProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiZoomStateObserverProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiPreviewViewStreamStateLiveDataProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiPreviewViewStreamStateObserverProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    ...
    PigeonApiUIViewProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiResolutionStrategyProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiResolutionSelectorBuilderProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    ...
    PigeonApiCameraSelectorBuilderProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiCameraSelectorProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiFocusMeteringActionBuilderProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    ...
    PigeonApiFileOutputOptionsBuilderProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    ...
    PigeonApiVNImageRequestHandlerProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNRequestProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNImageBasedRequestProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNDetectedObjectObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNRectangleObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNDetectBarcodesRequestProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNBarcodeObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNDetectFaceRectanglesRequestProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNFaceLandmarkRegionProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNFaceLandmarkRegion2DProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNFaceLandmarksProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNFaceLandmarks2DProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiVNFaceObservationProxyApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
  }
}
private class CameraXApiPigeonInternalProxyApiCodecReaderWriter: FlutterStandardReaderWriter {
  ...
  private class CameraXApiPigeonInternalProxyApiCodecWriter: CameraXApiPigeonCodecWriter {
    ...
    override func writeValue(_ value: Any) {
      if value is [Any] || value is Bool || value is Data || value is [AnyHashable: Any] || value is Double || value is FlutterStandardTypedData || value is Int64 || value is String || value is AVCaptureDeviceCinematicVideoFocusModeApi || value is AVMetadataObjectTypeApi || value is TimeUnitApi || value is ImageFormatApi || value is SurfaceRotationApi || value is AspectRatioStrategyFallbackRuleApi || value is ResolutionSelectorModeApi || value is ResolutionStrategyFallbackRuleApi || value is AspectRatioApi || value is CameraSelectorLensFacingApi || value is CameraStateApi || value is DynamicRangeEncodingApi || value is DynamicRangeBitDepthApi || value is ImageAnalysisStrategyApi || value is ImageAnalysisCoordinateSystemApi || value is ImageAnalysisOutputImageFormatApi || value is ImageCaptureCaptureModeApi || value is ImageCaptureFlashModeApi || value is FocusMeteringActionMeteringModeApi || value is MirrorModeApi || value is TorchStateApi || value is AudioStatsAudioStateApi || value is VideoRecordEventFinalizeErrorApi || value is CameraControllerUseCaseApi || value is PreviewViewScaleTypeApi || value is PreviewViewStreamStateApi || value is VNBarcodeSymbologyApi {
        super.writeValue(value)
        return
      }


      if #available(iOS 26.0.0, *), let instance = value as? AVMetadataCatHeadObject {
        pigeonRegistrar.apiDelegate.pigeonApiAVMetadataCatHeadObjectProxyApi(pigeonRegistrar).pigeonNewInstance(
      ...
      if #available(iOS 26.0.0, *), let instance = value as? AVMetadataDogHeadObject {
        pigeonRegistrar.apiDelegate.pigeonApiAVMetadataDogHeadObjectProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? AVMetadataCatBodyObject {
      ...
      if let instance = value as? AVMetadataDogBodyObject {
      ...
      if let instance = value as? AVMetadataHumanBodyObject {
      ...
      if let instance = value as? AVMetadataBodyObject {
      ...
      if let instance = value as? AVMetadataSalientObject {
      ...
      if let instance = value as? CameraStateLiveData {
        pigeonRegistrar.apiDelegate.pigeonApiCameraStateLiveDataProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? TorchStateLiveData {
        pigeonRegistrar.apiDelegate.pigeonApiTorchStateLiveDataProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? ZoomStateLiveData {
        pigeonRegistrar.apiDelegate.pigeonApiZoomStateLiveDataProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? PreviewViewStreamStateLiveData {
        pigeonRegistrar.apiDelegate.pigeonApiPreviewViewStreamStateLiveDataProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? PreviewViewStreamStateObserver {
        pigeonRegistrar.apiDelegate.pigeonApiPreviewViewStreamStateObserverProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? ResolutionSelector.Builder {
        pigeonRegistrar.apiDelegate.pigeonApiResolutionSelectorBuilderProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? CameraSelector.Builder {
        pigeonRegistrar.apiDelegate.pigeonApiCameraSelectorBuilderProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? FocusMeteringAction.Builder {
        pigeonRegistrar.apiDelegate.pigeonApiFocusMeteringActionBuilderProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? FileOutputOptions.Builder {
        pigeonRegistrar.apiDelegate.pigeonApiFileOutputOptionsBuilderProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VideoRecordEvent.Status {
        pigeonRegistrar.apiDelegate.pigeonApiVideoRecordEventStatusProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VideoRecordEvent.Start {
        pigeonRegistrar.apiDelegate.pigeonApiVideoRecordEventStartProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VideoRecordEvent.Pause {
        pigeonRegistrar.apiDelegate.pigeonApiVideoRecordEventPauseProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VideoRecordEvent.Resume {
        pigeonRegistrar.apiDelegate.pigeonApiVideoRecordEventResumeProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VideoRecordEvent.Finalize {
        pigeonRegistrar.apiDelegate.pigeonApiVideoRecordEventFinalizeProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? UIView {
        pigeonRegistrar.apiDelegate.pigeonApiUIViewProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNImageRequestHandler {
        pigeonRegistrar.apiDelegate.pigeonApiVNImageRequestHandlerProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNDetectBarcodesRequest {
        pigeonRegistrar.apiDelegate.pigeonApiVNDetectBarcodesRequestProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNBarcodeObservation {
        pigeonRegistrar.apiDelegate.pigeonApiVNBarcodeObservationProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNRectangleObservation {
        pigeonRegistrar.apiDelegate.pigeonApiVNRectangleObservationProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNDetectFaceRectanglesRequest {
        pigeonRegistrar.apiDelegate.pigeonApiVNDetectFaceRectanglesRequestProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNImageBasedRequest {
        pigeonRegistrar.apiDelegate.pigeonApiVNImageBasedRequestProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNRequest {
        pigeonRegistrar.apiDelegate.pigeonApiVNRequestProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNFaceLandmarkRegion2D {
        pigeonRegistrar.apiDelegate.pigeonApiVNFaceLandmarkRegion2DProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNFaceLandmarkRegion {
        pigeonRegistrar.apiDelegate.pigeonApiVNFaceLandmarkRegionProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNFaceLandmarks2D {
        pigeonRegistrar.apiDelegate.pigeonApiVNFaceLandmarks2DProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNFaceLandmarks {
        pigeonRegistrar.apiDelegate.pigeonApiVNFaceLandmarksProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNFaceObservation {
        pigeonRegistrar.apiDelegate.pigeonApiVNFaceObservationProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNDetectedObjectObservation {
        pigeonRegistrar.apiDelegate.pigeonApiVNDetectedObjectObservationProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? VNObservation {
        pigeonRegistrar.apiDelegate.pigeonApiVNObservationProxyApi(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
...
enum AVCaptureDeviceCinematicVideoFocusModeApi: Int, CaseIterable {
  case none = 0
  case strong = 1
  case weak = 2
}

enum AVMetadataObjectTypeApi: Int, CaseIterable {
  case codabar = 0
  case code39 = 1
  case code39Mod43 = 2
  case code93 = 3
  ...
  case catBody = 24
  case face = 25
  case salientObject = 26
}

enum TimeUnitApi: Int, CaseIterable {
  case nanoseconds = 0
  case microseconds = 1
  case milliseconds = 2
  case seconds = 3
...
enum ImageFormatApi: Int, CaseIterable {
  case depth16 = 0
  case depthJpeg = 1
...
enum SurfaceRotationApi: Int, CaseIterable {
  case rotation0 = 0
  case rotation90 = 1
  case rotation180 = 2
  case rotation270 = 3
...
enum AspectRatioStrategyFallbackRuleApi: Int, CaseIterable {
  case none = 0
  case auto = 1
}

enum ResolutionSelectorModeApi: Int, CaseIterable {
  case preferCaptureRateOverHigherResolution = 0
  case preferHigherResolutionOverCaptureRate = 1
}

enum ResolutionStrategyFallbackRuleApi: Int, CaseIterable {
  case none = 0
...
enum AspectRatioApi: Int, CaseIterable {
  case ratioDefault = 0
  case ratio43 = 1
  case ratio169 = 2
}

enum CameraSelectorLensFacingApi: Int, CaseIterable {
  case unknown = 0
  case front = 1
  case back = 2
  case external = 3
...
enum CameraStateApi: Int, CaseIterable {
  case pendingOpen = 0
  case opening = 1
  case open = 2
  case closing = 3
...
enum DynamicRangeEncodingApi: Int, CaseIterable {
  case unspecified = 0
  case sdr = 1
...
enum DynamicRangeBitDepthApi: Int, CaseIterable {
  case unspecified = 0
  case eightBit = 1
  case tenBit = 2
}

enum ImageAnalysisStrategyApi: Int, CaseIterable {
  case keepOnlyLatest = 0
  case blockProducer = 1
}

enum ImageAnalysisCoordinateSystemApi: Int, CaseIterable {
  case original = 0
  case sensor = 1
  case viewReferenced = 2
}

enum ImageAnalysisOutputImageFormatApi: Int, CaseIterable {
  case yuv420888 = 0
  case rgba8888 = 1
  case nv21 = 2
}

enum ImageCaptureCaptureModeApi: Int, CaseIterable {
  case maximizeQuality = 0
  case minimizeLatency = 1
  case zeroShutterLag = 2
}

enum ImageCaptureFlashModeApi: Int, CaseIterable {
  case auto = 0
  case on = 1
  case off = 2
  case screen = 3
...
enum FocusMeteringActionMeteringModeApi: Int, CaseIterable {
  case af = 0
  case ae = 1
  case awb = 2
}

enum MirrorModeApi: Int, CaseIterable {
  case off = 0
  case on = 1
  case onFrontOnly = 2
}

enum TorchStateApi: Int, CaseIterable {
  case off = 0
  case on = 1
}

enum AudioStatsAudioStateApi: Int, CaseIterable {
  case active = 0
  case disabled = 1
...
enum VideoRecordEventFinalizeErrorApi: Int, CaseIterable {
  case none = 0
  case unknown = 1
...
enum CameraControllerUseCaseApi: Int, CaseIterable {
  case imageCapture = 0
  case imageAnalysis = 1
  case videoCapture = 2
}

enum PreviewViewScaleTypeApi: Int, CaseIterable {
  case fillStart = 0
  case fillCenter = 1
  case fillEnd = 2
  case fitStart = 3
...
enum PreviewViewStreamStateApi: Int, CaseIterable {
  case idle = 0
  case streaming = 1
}

enum VNBarcodeSymbologyApi: Int, CaseIterable {
  case aztec = 0
  case codabar = 1
  case code39 = 2
  ...
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 129:
      ...
      if let enumResultAsInt = enumResultAsInt {
        return AVCaptureDeviceCinematicVideoFocusModeApi(rawValue: enumResultAsInt)
      }
      return nil
    case 130:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
    ...
    case 133:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return SurfaceRotationApi(rawValue: enumResultAsInt)
      }
      return nil
    case 134:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
    ...
    case 151:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return VideoRecordEventFinalizeErrorApi(rawValue: enumResultAsInt)
      }
      return nil
    case 152:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
    ...
    case 154:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return PreviewViewStreamStateApi(rawValue: enumResultAsInt)
      }
      return nil
    case 155:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
...
private class CameraXApiPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? AVCaptureDeviceCinematicVideoFocusModeApi {
      super.writeByte(129)
      ...
      super.writeByte(132)
      super.writeValue(value.rawValue)
    } else if let value = value as? SurfaceRotationApi {
      super.writeByte(133)
      super.writeValue(value.rawValue)
      ...
      super.writeByte(150)
      super.writeValue(value.rawValue)
    } else if let value = value as? VideoRecordEventFinalizeErrorApi {
      super.writeByte(151)
      super.writeValue(value.rawValue)
      ...
      super.writeByte(153)
      super.writeValue(value.rawValue)
    } else if let value = value as? PreviewViewStreamStateApi {
      super.writeByte(154)
      super.writeValue(value.rawValue)
...
protocol PigeonApiDelegateAVMetadataObjectProxyApi {
...
final class PigeonApiAVMetadataObjectProxyApi: PigeonApiProtocolAVMetadataObjectProxyApi  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiAVMetadataObjectProxyApi?) {
    ...
    let getTypeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataObjectProxyApi.getType", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getTypeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataObject
        do {
          let result = try api.pigeonDelegate.getType(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
      ...
      getTypeChannel.setMessageHandler(nil)
    }
    let getTimeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataObjectProxyApi.getTime", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getTimeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataObject
        do {
          let result = try api.pigeonDelegate.getTime(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getTimeChannel.setMessageHandler(nil)
    }
    let getDurationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataObjectProxyApi.getDuration", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getDurationChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataObject
        do {
          let result = try api.pigeonDelegate.getDuration(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    let getBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataObjectProxyApi.getBounds", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getBoundsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataObject
        do {
          let result = try api.pigeonDelegate.getBounds(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    let isFixedFocusChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataObjectProxyApi.isFixedFocus", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      isFixedFocusChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataObject
        do {
          let result = try api.pigeonDelegate.isFixedFocus(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      isFixedFocusChannel.setMessageHandler(nil)
    }
    let getCinematicVideoFocusModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataObjectProxyApi.getCinematicVideoFocusMode", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getCinematicVideoFocusModeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataObject
        do {
          let result = try api.pigeonDelegate.getCinematicVideoFocusMode(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getCinematicVideoFocusModeChannel.setMessageHandler(nil)
    }
    let getGroupIDChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataObjectProxyApi.getGroupID", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getGroupIDChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataObject
        do {
          let result = try api.pigeonDelegate.getGroupID(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getGroupIDChannel.setMessageHandler(nil)
    }
    let getObjectIDChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataObjectProxyApi.getObjectID", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getObjectIDChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataObject
        do {
          let result = try api.pigeonDelegate.getObjectID(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getObjectIDChannel.setMessageHandler(nil)
    }
  }
...
open class PigeonApiDelegateAVMetadataCatHeadObjectProxyApi {
}

protocol PigeonApiProtocolAVMetadataCatHeadObjectProxyApi {
}

final class PigeonApiAVMetadataCatHeadObjectProxyApi: PigeonApiProtocolAVMetadataCatHeadObjectProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateAVMetadataCatHeadObjectProxyApi
  ...
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateAVMetadataCatHeadObjectProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  ///Creates a Dart instance of AVMetadataCatHeadObjectProxyApi and attaches it to [pigeonInstance].
  @available(iOS 26.0.0, *)
  func pigeonNewInstance(pigeonInstance: AVMetadataCatHeadObject, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.AVMetadataCatHeadObjectProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
open class PigeonApiDelegateAVMetadataDogHeadObjectProxyApi {
}

protocol PigeonApiProtocolAVMetadataDogHeadObjectProxyApi {
}

final class PigeonApiAVMetadataDogHeadObjectProxyApi: PigeonApiProtocolAVMetadataDogHeadObjectProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateAVMetadataDogHeadObjectProxyApi
  ///An implementation of [AVMetadataObjectProxyApi] used to access callback methods
  var pigeonApiAVMetadataObjectProxyApi: PigeonApiAVMetadataObjectProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiAVMetadataObjectProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateAVMetadataDogHeadObjectProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  ///Creates a Dart instance of AVMetadataDogHeadObjectProxyApi and attaches it to [pigeonInstance].
  @available(iOS 26.0.0, *)
  func pigeonNewInstance(pigeonInstance: AVMetadataDogHeadObject, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.AVMetadataDogHeadObjectProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateAVMetadataBodyObjectProxyApi {
...
final class PigeonApiAVMetadataBodyObjectProxyApi: PigeonApiProtocolAVMetadataBodyObjectProxyApi  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiAVMetadataBodyObjectProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getBodyIDChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataBodyObjectProxyApi.getBodyID", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getBodyIDChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataBodyObject
        do {
          let result = try api.pigeonDelegate.getBodyID(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getBodyIDChannel.setMessageHandler(nil)
    }
  }
...
open class PigeonApiDelegateAVMetadataCatBodyObjectProxyApi {
}
...
open class PigeonApiDelegateAVMetadataDogBodyObjectProxyApi {
}
...
open class PigeonApiDelegateAVMetadataHumanBodyObjectProxyApi {
}
...
open class PigeonApiDelegateAVMetadataHumanFullBodyObjectProxyApi {
}
...
final class PigeonApiAVMetadataFaceObjectProxyApi: PigeonApiProtocolAVMetadataFaceObjectProxyApi  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiAVMetadataFaceObjectProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getFaceIDChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataFaceObjectProxyApi.getFaceID", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getFaceIDChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataFaceObject
        do {
          let result = try api.pigeonDelegate.getFaceID(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getFaceIDChannel.setMessageHandler(nil)
    }
    let hasRollAngleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataFaceObjectProxyApi.hasRollAngle", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      hasRollAngleChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataFaceObject
        do {
          let result = try api.pigeonDelegate.hasRollAngle(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      hasRollAngleChannel.setMessageHandler(nil)
    }
    let getRollAngleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataFaceObjectProxyApi.getRollAngle", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getRollAngleChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataFaceObject
        do {
          let result = try api.pigeonDelegate.getRollAngle(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getRollAngleChannel.setMessageHandler(nil)
    }
    let hasYawAngleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataFaceObjectProxyApi.hasYawAngle", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      hasYawAngleChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataFaceObject
        do {
          let result = try api.pigeonDelegate.hasYawAngle(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      hasYawAngleChannel.setMessageHandler(nil)
    }
    let getYawAngleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataFaceObjectProxyApi.getYawAngle", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getYawAngleChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataFaceObject
        do {
          let result = try api.pigeonDelegate.getYawAngle(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getYawAngleChannel.setMessageHandler(nil)
    }
  }
...
final class PigeonApiAVMetadataMachineReadableCodeObjectProxyApi: PigeonApiProtocolAVMetadataMachineReadableCodeObjectProxyApi  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiAVMetadataMachineReadableCodeObjectProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getCornersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataMachineReadableCodeObjectProxyApi.getCorners", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getCornersChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataMachineReadableCodeObject
        do {
          let result = try api.pigeonDelegate.getCorners(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getCornersChannel.setMessageHandler(nil)
    }
    let getStringValueChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVMetadataMachineReadableCodeObjectProxyApi.getStringValue", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getStringValueChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVMetadataMachineReadableCodeObject
        do {
          let result = try api.pigeonDelegate.getStringValue(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getStringValueChannel.setMessageHandler(nil)
    }
  }
...
open class PigeonApiDelegateAVMetadataSalientObjectProxyApi {
}
...
final class PigeonApiAVAnalyzerResultProxyApi: PigeonApiProtocolAVAnalyzerResultProxyApi  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiAVAnalyzerResultProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getObjectsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.AVAnalyzerResultProxyApi.getObjects", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getObjectsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! AVAnalyzer.Result
        do {
          let result = try api.pigeonDelegate.getObjects(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getObjectsChannel.setMessageHandler(nil)
    }
  }
      ...
      completion(
        .failure(
          CameraXError(
            ...
            message: "Callback to `AVAnalyzerResultConsumerProxyApi.accept` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `ImageProxyConsumerProxyApi.accept` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `VideoRecordEventConsumerProxyApi.accept` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
protocol PigeonApiDelegateCameraStateLiveDataProxyApi {
...
protocol PigeonApiProtocolCameraStateLiveDataProxyApi {
}

final class PigeonApiCameraStateLiveDataProxyApi: PigeonApiProtocolCameraStateLiveDataProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateCameraStateLiveDataProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateCameraStateLiveDataProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiCameraStateLiveDataProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getValueChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.CameraStateLiveDataProxyApi.getValue", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let observeForeverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.CameraStateLiveDataProxyApi.observeForever", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      observeForeverChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! CameraStateLiveData
        let observerArg = args[1] as! CameraStateObserver
        do {
          try api.pigeonDelegate.observeForever(pigeonApi: api, pigeonInstance: pigeonInstanceArg, observer: observerArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      observeForeverChannel.setMessageHandler(nil)
    }
    let removeObserverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.CameraStateLiveDataProxyApi.removeObserver", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
  ...
  ///Creates a Dart instance of CameraStateLiveDataProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: CameraStateLiveData, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.CameraStateLiveDataProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `CameraStateObserverProxyApi.onChanged` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
protocol PigeonApiDelegateTorchStateLiveDataProxyApi {
...
protocol PigeonApiProtocolTorchStateLiveDataProxyApi {
}

final class PigeonApiTorchStateLiveDataProxyApi: PigeonApiProtocolTorchStateLiveDataProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateTorchStateLiveDataProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateTorchStateLiveDataProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiTorchStateLiveDataProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getValueChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.TorchStateLiveDataProxyApi.getValue", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getValueChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let observeForeverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.TorchStateLiveDataProxyApi.observeForever", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      observeForeverChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! TorchStateLiveData
    ...
    let removeObserverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.TorchStateLiveDataProxyApi.removeObserver", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      removeObserverChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! TorchStateLiveData
  ...
  ///Creates a Dart instance of TorchStateLiveDataProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: TorchStateLiveData, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.TorchStateLiveDataProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `TorchStateObserverProxyApi.onChanged` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
protocol PigeonApiDelegateZoomStateLiveDataProxyApi {
...
protocol PigeonApiProtocolZoomStateLiveDataProxyApi {
}

final class PigeonApiZoomStateLiveDataProxyApi: PigeonApiProtocolZoomStateLiveDataProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateZoomStateLiveDataProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateZoomStateLiveDataProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiZoomStateLiveDataProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getValueChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.ZoomStateLiveDataProxyApi.getValue", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getValueChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let observeForeverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.ZoomStateLiveDataProxyApi.observeForever", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      observeForeverChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! ZoomStateLiveData
    ...
    let removeObserverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.ZoomStateLiveDataProxyApi.removeObserver", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      removeObserverChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! ZoomStateLiveData
  ...
  ///Creates a Dart instance of ZoomStateLiveDataProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: ZoomStateLiveData, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.ZoomStateLiveDataProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `ZoomStateObserverProxyApi.onChanged` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
protocol PigeonApiDelegatePreviewViewStreamStateLiveDataProxyApi {
...
protocol PigeonApiProtocolPreviewViewStreamStateLiveDataProxyApi {
}

final class PigeonApiPreviewViewStreamStateLiveDataProxyApi: PigeonApiProtocolPreviewViewStreamStateLiveDataProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegatePreviewViewStreamStateLiveDataProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegatePreviewViewStreamStateLiveDataProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiPreviewViewStreamStateLiveDataProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getValueChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.PreviewViewStreamStateLiveDataProxyApi.getValue", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getValueChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! PreviewViewStreamStateLiveData
        do {
          let result = try api.pigeonDelegate.getValue(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
    ...
    let observeForeverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.PreviewViewStreamStateLiveDataProxyApi.observeForever", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      observeForeverChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! PreviewViewStreamStateLiveData
        let observerArg = args[1] as! PreviewViewStreamStateObserver
        do {
          try api.pigeonDelegate.observeForever(pigeonApi: api, pigeonInstance: pigeonInstanceArg, observer: observerArg)
          reply(wrapResult(nil))
        } catch {
    ...
    let removeObserverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.PreviewViewStreamStateLiveDataProxyApi.removeObserver", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      removeObserverChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! PreviewViewStreamStateLiveData
  ...
  ///Creates a Dart instance of PreviewViewStreamStateLiveDataProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: PreviewViewStreamStateLiveData, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.PreviewViewStreamStateLiveDataProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegatePreviewViewStreamStateObserverProxyApi {
...
protocol PigeonApiProtocolPreviewViewStreamStateObserverProxyApi {
  func onChanged(pigeonInstance pigeonInstanceArg: PreviewViewStreamStateObserver, value valueArg: PreviewViewStreamStateApi, completion: @escaping (Result<Void, CameraXError>) -> Void)
}

final class PigeonApiPreviewViewStreamStateObserverProxyApi: PigeonApiProtocolPreviewViewStreamStateObserverProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegatePreviewViewStreamStateObserverProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegatePreviewViewStreamStateObserverProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiPreviewViewStreamStateObserverProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.PreviewViewStreamStateObserverProxyApi.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
...
withIdentifier: pigeonIdentifierArg)
  ...
  ///Creates a Dart instance of PreviewViewStreamStateObserverProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: PreviewViewStreamStateObserver, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      completion(
        .failure(
          CameraXError(
            code: "new-instance-error",
            message: "Error: Attempting to create a new Dart instance of PreviewViewStreamStateObserverProxyApi, but the class has a nonnull callback method.", details: "")))
    }
  }
  func onChanged(pigeonInstance pigeonInstanceArg: PreviewViewStreamStateObserver, value valueArg: PreviewViewStreamStateApi, completion: @escaping (Result<Void, CameraXError>) -> Void)   {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `PreviewViewStreamStateObserverProxyApi.onChanged` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    let channelName: String = "dev.flutter.pigeon.camerax_ios.PreviewViewStreamStateObserverProxyApi.onChanged"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([pigeonInstanceArg, valueArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateUIViewProxyApi {
...
protocol PigeonApiProtocolUIViewProxyApi {
}

final class PigeonApiUIViewProxyApi: PigeonApiProtocolUIViewProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateUIViewProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateUIViewProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiUIViewProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getAlphaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.UIViewProxyApi.getAlpha", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getAlphaChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! UIView
        do {
          let result = try api.pigeonDelegate.getAlpha(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getAlphaChannel.setMessageHandler(nil)
    }
    let setAlphaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.UIViewProxyApi.setAlpha", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setAlphaChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setAlpha(pigeonApi: api, pigeonInstance: pigeonInstanceArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let isHiddenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.UIViewProxyApi.isHidden", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      isHiddenChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! UIView
        do {
          let result = try api.pigeonDelegate.isHidden(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      isHiddenChannel.setMessageHandler(nil)
    }
    let isOpaqueChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.UIViewProxyApi.isOpaque", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      isOpaqueChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! UIView
        do {
          let result = try api.pigeonDelegate.isOpaque(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      isOpaqueChannel.setMessageHandler(nil)
    }
    let setHiddenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.UIViewProxyApi.setHidden", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setHiddenChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! UIView
        let valueArg = args[1] as! Bool
        do {
          try api.pigeonDelegate.setHidden(pigeonApi: api, pigeonInstance: pigeonInstanceArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setHiddenChannel.setMessageHandler(nil)
    }
    let setOpaqueChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.UIViewProxyApi.setOpaque", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setOpaqueChannel.setMessageHandler { message, reply in
        ...
        let valueArg = args[1] as! Bool
        do {
          try api.pigeonDelegate.setOpaque(pigeonApi: api, pigeonInstance: pigeonInstanceArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
  ...
  ///Creates a Dart instance of UIViewProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: UIView, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.UIViewProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateResolutionSelectorBuilderProxyApi {
...
protocol PigeonApiProtocolResolutionSelectorBuilderProxyApi {
}

final class PigeonApiResolutionSelectorBuilderProxyApi: PigeonApiProtocolResolutionSelectorBuilderProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateResolutionSelectorBuilderProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateResolutionSelectorBuilderProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiResolutionSelectorBuilderProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.ResolutionSelectorBuilderProxyApi.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
...
withIdentifier: pigeonIdentifierArg)
    ...
    let setResolutionStrategyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.ResolutionSelectorBuilderProxyApi.setResolutionStrategy", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setResolutionStrategyChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! ResolutionSelector.Builder
        let resolutionStrategyArg = args[1] as! ResolutionStrategy
        do {
          let result = try api.pigeonDelegate.setResolutionStrategy(pigeonApi: api, pigeonInstance: pigeonInstanceArg, resolutionStrategy: resolutionStrategyArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      setResolutionStrategyChannel.setMessageHandler(nil)
    }
    let buildChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.ResolutionSelectorBuilderProxyApi.build", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      buildChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! ResolutionSelector.Builder
        do {
          let result = try api.pigeonDelegate.build(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
  ...
  ///Creates a Dart instance of ResolutionSelectorBuilderProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: ResolutionSelector.Builder, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.ResolutionSelectorBuilderProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
final class PigeonApiCameraInfoProxyApi: PigeonApiProtocolCameraInfoProxyApi  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiCameraInfoProxyApi?) {
    ...
    let getSensorRotationDegrees1Channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.CameraInfoProxyApi.getSensorRotationDegrees1", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSensorRotationDegrees1Channel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! CameraInfo
        do {
          let result = try api.pigeonDelegate.getSensorRotationDegrees1(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getSensorRotationDegrees1Channel.setMessageHandler(nil)
    }
    let getSensorRotationDegrees2Channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.CameraInfoProxyApi.getSensorRotationDegrees2", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSensorRotationDegrees2Channel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! CameraInfo
        let relativeRotationArg = args[1] as! SurfaceRotationApi
        do {
          let result = try api.pigeonDelegate.getSensorRotationDegrees2(pigeonApi: api, pigeonInstance: pigeonInstanceArg, relativeRotation: relativeRotationArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getSensorRotationDegrees2Channel.setMessageHandler(nil)
    }
...
protocol PigeonApiDelegateCameraSelectorBuilderProxyApi {
...
protocol PigeonApiProtocolCameraSelectorBuilderProxyApi {
}

final class PigeonApiCameraSelectorBuilderProxyApi: PigeonApiProtocolCameraSelectorBuilderProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateCameraSelectorBuilderProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateCameraSelectorBuilderProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiCameraSelectorBuilderProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.CameraSelectorBuilderProxyApi.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
...
withIdentifier: pigeonIdentifierArg)
    ...
    let requireLensFacingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.CameraSelectorBuilderProxyApi.requireLensFacing", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      requireLensFacingChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! CameraSelector.Builder
        let lensFacingArg = args[1] as! CameraSelectorLensFacingApi
        do {
          let result = try api.pigeonDelegate.requireLensFacing(pigeonApi: api, pigeonInstance: pigeonInstanceArg, lensFacing: lensFacingArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      requireLensFacingChannel.setMessageHandler(nil)
    }
    let buildChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.CameraSelectorBuilderProxyApi.build", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      buildChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! CameraSelector.Builder
  ...
  ///Creates a Dart instance of CameraSelectorBuilderProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: CameraSelector.Builder, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.CameraSelectorBuilderProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateFocusMeteringActionBuilderProxyApi {
...
protocol PigeonApiProtocolFocusMeteringActionBuilderProxyApi {
}

final class PigeonApiFocusMeteringActionBuilderProxyApi: PigeonApiProtocolFocusMeteringActionBuilderProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateFocusMeteringActionBuilderProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateFocusMeteringActionBuilderProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiFocusMeteringActionBuilderProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let new1Channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FocusMeteringActionBuilderProxyApi.new1", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      new1Channel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
        let pointArg = args[1] as! MeteringPoint
        do {
          api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
try api.pigeonDelegate.new1(pigeonApi: api, point: pointArg),
withIdentifier: pigeonIdentifierArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
      ...
      new1Channel.setMessageHandler(nil)
    }
    let new2Channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FocusMeteringActionBuilderProxyApi.new2", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      new2Channel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
        let pointArg = args[1] as! MeteringPoint
        let meteringModesArg = args[2] as! [FocusMeteringActionMeteringModeApi]
        do {
          api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
try api.pigeonDelegate.new2(pigeonApi: api, point: pointArg, meteringModes: meteringModesArg),
withIdentifier: pigeonIdentifierArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
      ...
      new2Channel.setMessageHandler(nil)
    }
    let addPoint1Channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FocusMeteringActionBuilderProxyApi.addPoint1", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      addPoint1Channel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! FocusMeteringAction.Builder
        let pointArg = args[1] as! MeteringPoint
        do {
          let result = try api.pigeonDelegate.addPoint1(pigeonApi: api, pigeonInstance: pigeonInstanceArg, point: pointArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      addPoint1Channel.setMessageHandler(nil)
    }
    let addPoint2Channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FocusMeteringActionBuilderProxyApi.addPoint2", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      addPoint2Channel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! FocusMeteringAction.Builder
        let pointArg = args[1] as! MeteringPoint
        let meteringModesArg = args[2] as! [FocusMeteringActionMeteringModeApi]
        do {
          let result = try api.pigeonDelegate.addPoint2(pigeonApi: api, pigeonInstance: pigeonInstanceArg, point: pointArg, meteringModes: meteringModesArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      addPoint2Channel.setMessageHandler(nil)
    }
    let disableAutoCancelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FocusMeteringActionBuilderProxyApi.disableAutoCancel", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      disableAutoCancelChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! FocusMeteringAction.Builder
        do {
          let result = try api.pigeonDelegate.disableAutoCancel(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      disableAutoCancelChannel.setMessageHandler(nil)
    }
    let setAutoCancelDurationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FocusMeteringActionBuilderProxyApi.setAutoCancelDuration", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setAutoCancelDurationChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! FocusMeteringAction.Builder
        let durationArg = args[1] as! Int64
        let timeUnitArg = args[2] as! TimeUnitApi
        do {
          let result = try api.pigeonDelegate.setAutoCancelDuration(pigeonApi: api, pigeonInstance: pigeonInstanceArg, duration: durationArg, timeUnit: timeUnitArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      setAutoCancelDurationChannel.setMessageHandler(nil)
    }
    let buildChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FocusMeteringActionBuilderProxyApi.build", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      buildChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! FocusMeteringAction.Builder
  ...
  ///Creates a Dart instance of FocusMeteringActionBuilderProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: FocusMeteringAction.Builder, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.FocusMeteringActionBuilderProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `ImageCaptureOnImageCapturedCallbackProxyApi.onCaptureStarted` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `ImageCaptureOnImageCapturedCallbackProxyApi.onCaptureProcessProgressed` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `ImageCaptureOnImageCapturedCallbackProxyApi.onCaptureSuccess` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `ImageCaptureOnImageCapturedCallbackProxyApi.onError` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
protocol PigeonApiDelegateFileOutputOptionsBuilderProxyApi {
...
protocol PigeonApiProtocolFileOutputOptionsBuilderProxyApi {
}

final class PigeonApiFileOutputOptionsBuilderProxyApi: PigeonApiProtocolFileOutputOptionsBuilderProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateFileOutputOptionsBuilderProxyApi
  ...
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateFileOutputOptionsBuilderProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiFileOutputOptionsBuilderProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FileOutputOptionsBuilderProxyApi.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
        ...
        do {
          api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
try api.pigeonDelegate.pigeonDefaultConstructor(pigeonApi: api, file: fileArg),
withIdentifier: pigeonIdentifierArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
    ...
    let setDurationLimitMillisChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FileOutputOptionsBuilderProxyApi.setDurationLimitMillis", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setDurationLimitMillisChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! FileOutputOptions.Builder
        let durationLimitMillisArg = args[1] as! Int64
        do {
          let result = try api.pigeonDelegate.setDurationLimitMillis(pigeonApi: api, pigeonInstance: pigeonInstanceArg, durationLimitMillis: durationLimitMillisArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      setDurationLimitMillisChannel.setMessageHandler(nil)
    }
    let setFileSizeLimitChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FileOutputOptionsBuilderProxyApi.setFileSizeLimit", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setFileSizeLimitChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! FileOutputOptions.Builder
        let fileSizeLimitBytesArg = args[1] as! Int64
        do {
          let result = try api.pigeonDelegate.setFileSizeLimit(pigeonApi: api, pigeonInstance: pigeonInstanceArg, fileSizeLimitBytes: fileSizeLimitBytesArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      setFileSizeLimitChannel.setMessageHandler(nil)
    }
    let setLocationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FileOutputOptionsBuilderProxyApi.setLocation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setLocationChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! FileOutputOptions.Builder
        let locationArg: CLLocation? = nilOrValue(args[1])
        do {
          let result = try api.pigeonDelegate.setLocation(pigeonApi: api, pigeonInstance: pigeonInstanceArg, location: locationArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      setLocationChannel.setMessageHandler(nil)
    }
    let buildChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.FileOutputOptionsBuilderProxyApi.build", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      buildChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! FileOutputOptions.Builder
  ...
  ///Creates a Dart instance of FileOutputOptionsBuilderProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: FileOutputOptions.Builder, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.FileOutputOptionsBuilderProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVideoRecordEventStatusProxyApi {
...
protocol PigeonApiProtocolVideoRecordEventStatusProxyApi {
}

final class PigeonApiVideoRecordEventStatusProxyApi: PigeonApiProtocolVideoRecordEventStatusProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVideoRecordEventStatusProxyApi
  ...
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVideoRecordEventStatusProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  ///Creates a Dart instance of VideoRecordEventStatusProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VideoRecordEvent.Status, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VideoRecordEventStatusProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
protocol PigeonApiDelegateVideoRecordEventStartProxyApi {
...
protocol PigeonApiProtocolVideoRecordEventStartProxyApi {
}

final class PigeonApiVideoRecordEventStartProxyApi: PigeonApiProtocolVideoRecordEventStartProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVideoRecordEventStartProxyApi
  ///An implementation of [VideoRecordEventProxyApi] used to access callback methods
  var pigeonApiVideoRecordEventProxyApi: PigeonApiVideoRecordEventProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVideoRecordEventProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVideoRecordEventStartProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  ///Creates a Dart instance of VideoRecordEventStartProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VideoRecordEvent.Start, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VideoRecordEventStartProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg, recordingStatsArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVideoRecordEventPauseProxyApi {
...
protocol PigeonApiProtocolVideoRecordEventPauseProxyApi {
}

final class PigeonApiVideoRecordEventPauseProxyApi: PigeonApiProtocolVideoRecordEventPauseProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVideoRecordEventPauseProxyApi
  ///An implementation of [VideoRecordEventProxyApi] used to access callback methods
  var pigeonApiVideoRecordEventProxyApi: PigeonApiVideoRecordEventProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVideoRecordEventProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVideoRecordEventPauseProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  ///Creates a Dart instance of VideoRecordEventPauseProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VideoRecordEvent.Pause, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VideoRecordEventPauseProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg, recordingStatsArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVideoRecordEventResumeProxyApi {
...
protocol PigeonApiProtocolVideoRecordEventResumeProxyApi {
}

final class PigeonApiVideoRecordEventResumeProxyApi: PigeonApiProtocolVideoRecordEventResumeProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVideoRecordEventResumeProxyApi
  ///An implementation of [VideoRecordEventProxyApi] used to access callback methods
  var pigeonApiVideoRecordEventProxyApi: PigeonApiVideoRecordEventProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVideoRecordEventProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVideoRecordEventResumeProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  ///Creates a Dart instance of VideoRecordEventResumeProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VideoRecordEvent.Resume, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VideoRecordEventResumeProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg, recordingStatsArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVideoRecordEventFinalizeProxyApi {
...
protocol PigeonApiProtocolVideoRecordEventFinalizeProxyApi {
}

final class PigeonApiVideoRecordEventFinalizeProxyApi: PigeonApiProtocolVideoRecordEventFinalizeProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVideoRecordEventFinalizeProxyApi
  ///An implementation of [VideoRecordEventProxyApi] used to access callback methods
  var pigeonApiVideoRecordEventProxyApi: PigeonApiVideoRecordEventProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVideoRecordEventProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVideoRecordEventFinalizeProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  ///Creates a Dart instance of VideoRecordEventFinalizeProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VideoRecordEvent.Finalize, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VideoRecordEventFinalizeProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg, recordingStatsArg, causeArg, errorArg, outputResultsArg, hasErrorArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
          return
        }
...
final class PigeonApiPreviewViewProxyApi: PigeonApiProtocolPreviewViewProxyApi  {
  ...
  ///An implementation of [UIViewProxyApi] used to access callback methods
  var pigeonApiUIViewProxyApi: PigeonApiUIViewProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiUIViewProxyApi(pigeonRegistrar)
  }
...
withIdentifier: pigeonIdentifierArg)
    ...
    let getPreviewStreamStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.PreviewViewProxyApi.getPreviewStreamState", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getPreviewStreamStateChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! PreviewView
        do {
          let result = try api.pigeonDelegate.getPreviewStreamState(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getPreviewStreamStateChannel.setMessageHandler(nil)
    }
  }
...
protocol PigeonApiProtocolRotationProviderListenerProxyApi {
  func onRotationChanged(pigeonInstance pigeonInstanceArg: RotationProvider.Listener, rotation rotationArg: SurfaceRotationApi, completion: @escaping (Result<Void, CameraXError>) -> Void)
}
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `RotationProviderListenerProxyApi.onRotationChanged` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
protocol PigeonApiDelegateVNImageRequestHandlerProxyApi {
...
protocol PigeonApiProtocolVNImageRequestHandlerProxyApi {
}

final class PigeonApiVNImageRequestHandlerProxyApi: PigeonApiProtocolVNImageRequestHandlerProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNImageRequestHandlerProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNImageRequestHandlerProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNImageRequestHandlerProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let urlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNImageRequestHandlerProxyApi.url", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      urlChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
        let urlArg = args[1] as! String
        do {
          api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
try api.pigeonDelegate.url(pigeonApi: api, url: urlArg),
withIdentifier: pigeonIdentifierArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
      ...
      urlChannel.setMessageHandler(nil)
    }
    let performChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNImageRequestHandlerProxyApi.perform", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      performChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNImageRequestHandler
        let requestsArg = args[1] as! [VNRequest]
        do {
          try api.pigeonDelegate.perform(pigeonApi: api, pigeonInstance: pigeonInstanceArg, requests: requestsArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
  ...
  ///Creates a Dart instance of VNImageRequestHandlerProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNImageRequestHandler, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNImageRequestHandlerProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVNRequestProxyApi {
...
protocol PigeonApiProtocolVNRequestProxyApi {
  func completionHandler(pigeonInstance pigeonInstanceArg: VNRequest, arg1 arg1Arg: [Any?]?, completion: @escaping (Result<Void, CameraXError>) -> Void)
}

final class PigeonApiVNRequestProxyApi: PigeonApiProtocolVNRequestProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNRequestProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNRequestProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNRequestProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getPreferBackgroundProcessingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNRequestProxyApi.getPreferBackgroundProcessing", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getPreferBackgroundProcessingChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNRequest
        do {
          let result = try api.pigeonDelegate.getPreferBackgroundProcessing(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getPreferBackgroundProcessingChannel.setMessageHandler(nil)
    }
    let setPreferBackgroundProcessingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNRequestProxyApi.setPreferBackgroundProcessing", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setPreferBackgroundProcessingChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNRequest
        let valueArg = args[1] as! Bool
        do {
          try api.pigeonDelegate.setPreferBackgroundProcessing(pigeonApi: api, pigeonInstance: pigeonInstanceArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setPreferBackgroundProcessingChannel.setMessageHandler(nil)
    }
    let getResultsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNRequestProxyApi.getResults", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getResultsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNRequest
        do {
          let result = try api.pigeonDelegate.getResults(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getResultsChannel.setMessageHandler(nil)
    }
    let cancelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNRequestProxyApi.cancel", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      cancelChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNRequest
        do {
          try api.pigeonDelegate.cancel(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
  ...
  ///Creates a Dart instance of VNRequestProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNRequest, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      completion(
        .failure(
          CameraXError(
            code: "new-instance-error",
            message: "Error: Attempting to create a new Dart instance of VNRequestProxyApi, but the class has a nonnull callback method.", details: "")))
    }
  }
  func completionHandler(pigeonInstance pigeonInstanceArg: VNRequest, arg1 arg1Arg: [Any?]?, completion: @escaping (Result<Void, CameraXError>) -> Void)   {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          CameraXError(
            code: "missing-instance-error",
            message: "Callback to `VNRequestProxyApi.completionHandler` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    let channelName: String = "dev.flutter.pigeon.camerax_ios.VNRequestProxyApi.completionHandler"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([pigeonInstanceArg, arg1Arg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
...
protocol PigeonApiDelegateVNImageBasedRequestProxyApi {
...
protocol PigeonApiProtocolVNImageBasedRequestProxyApi {
}

final class PigeonApiVNImageBasedRequestProxyApi: PigeonApiProtocolVNImageBasedRequestProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNImageBasedRequestProxyApi
  ///An implementation of [VNRequestProxyApi] used to access callback methods
  var pigeonApiVNRequestProxyApi: PigeonApiVNRequestProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVNRequestProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNImageBasedRequestProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNImageBasedRequestProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getRegionOfInterestChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNImageBasedRequestProxyApi.getRegionOfInterest", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getRegionOfInterestChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNImageBasedRequest
        do {
          let result = try api.pigeonDelegate.getRegionOfInterest(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getRegionOfInterestChannel.setMessageHandler(nil)
    }
    let setRegionOfInterestChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNImageBasedRequestProxyApi.setRegionOfInterest", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setRegionOfInterestChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNImageBasedRequest
        let valueArg = args[1] as! RectF
        do {
          try api.pigeonDelegate.setRegionOfInterest(pigeonApi: api, pigeonInstance: pigeonInstanceArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
  ...
  ///Creates a Dart instance of VNImageBasedRequestProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNImageBasedRequest, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      completion(
        .failure(
          CameraXError(
            code: "new-instance-error",
            message: "Error: Attempting to create a new Dart instance of VNImageBasedRequestProxyApi, but the class has a nonnull callback method.", details: "")))
    }
  }
}
protocol PigeonApiDelegateVNObservationProxyApi {
  func getConfidence(pigeonApi: PigeonApiVNObservationProxyApi, pigeonInstance: VNObservation) throws -> Double
}

protocol PigeonApiProtocolVNObservationProxyApi {
}

final class PigeonApiVNObservationProxyApi: PigeonApiProtocolVNObservationProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNObservationProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNObservationProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNObservationProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getConfidenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNObservationProxyApi.getConfidence", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getConfidenceChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNObservation
        do {
          let result = try api.pigeonDelegate.getConfidence(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getConfidenceChannel.setMessageHandler(nil)
    }
  }

  ///Creates a Dart instance of VNObservationProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNObservation, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNObservationProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVNDetectedObjectObservationProxyApi {
...
protocol PigeonApiProtocolVNDetectedObjectObservationProxyApi {
}

final class PigeonApiVNDetectedObjectObservationProxyApi: PigeonApiProtocolVNDetectedObjectObservationProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNDetectedObjectObservationProxyApi
  ///An implementation of [VNObservationProxyApi] used to access callback methods
  var pigeonApiVNObservationProxyApi: PigeonApiVNObservationProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVNObservationProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNDetectedObjectObservationProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNDetectedObjectObservationProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getBoundingBoxChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNDetectedObjectObservationProxyApi.getBoundingBox", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getBoundingBoxChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNDetectedObjectObservation
        do {
          let result = try api.pigeonDelegate.getBoundingBox(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getBoundingBoxChannel.setMessageHandler(nil)
    }
  }

  ///Creates a Dart instance of VNDetectedObjectObservationProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNDetectedObjectObservation, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNDetectedObjectObservationProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVNRectangleObservationProxyApi {
...
protocol PigeonApiProtocolVNRectangleObservationProxyApi {
}

final class PigeonApiVNRectangleObservationProxyApi: PigeonApiProtocolVNRectangleObservationProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNRectangleObservationProxyApi
  ///An implementation of [VNDetectedObjectObservationProxyApi] used to access callback methods
  var pigeonApiVNDetectedObjectObservationProxyApi: PigeonApiVNDetectedObjectObservationProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVNDetectedObjectObservationProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNRectangleObservationProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNRectangleObservationProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getBottomLeftChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNRectangleObservationProxyApi.getBottomLeft", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getBottomLeftChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNRectangleObservation
        do {
          let result = try api.pigeonDelegate.getBottomLeft(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getBottomLeftChannel.setMessageHandler(nil)
    }
    let getBottomRightChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNRectangleObservationProxyApi.getBottomRight", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getBottomRightChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNRectangleObservation
        do {
          let result = try api.pigeonDelegate.getBottomRight(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getBottomRightChannel.setMessageHandler(nil)
    }
    let getTopLeftChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNRectangleObservationProxyApi.getTopLeft", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getTopLeftChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNRectangleObservation
        do {
          let result = try api.pigeonDelegate.getTopLeft(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getTopLeftChannel.setMessageHandler(nil)
    }
    let getTopRightChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNRectangleObservationProxyApi.getTopRight", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getTopRightChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNRectangleObservation
        do {
          let result = try api.pigeonDelegate.getTopRight(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getTopRightChannel.setMessageHandler(nil)
    }
  }

  ///Creates a Dart instance of VNRectangleObservationProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNRectangleObservation, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNRectangleObservationProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVNDetectBarcodesRequestProxyApi {
...
protocol PigeonApiProtocolVNDetectBarcodesRequestProxyApi {
}

final class PigeonApiVNDetectBarcodesRequestProxyApi: PigeonApiProtocolVNDetectBarcodesRequestProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNDetectBarcodesRequestProxyApi
  ///An implementation of [VNImageBasedRequestProxyApi] used to access callback methods
  var pigeonApiVNImageBasedRequestProxyApi: PigeonApiVNImageBasedRequestProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVNImageBasedRequestProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNDetectBarcodesRequestProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNDetectBarcodesRequestProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNDetectBarcodesRequestProxyApi.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
...
withIdentifier: pigeonIdentifierArg)
    ...
    let getSupportedSymbologiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNDetectBarcodesRequestProxyApi.getSupportedSymbologies", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSupportedSymbologiesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNDetectBarcodesRequest
        do {
          let result = try api.pigeonDelegate.getSupportedSymbologies(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getSupportedSymbologiesChannel.setMessageHandler(nil)
    }
    let getSymbologiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNDetectBarcodesRequestProxyApi.getSymbologies", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSymbologiesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNDetectBarcodesRequest
        do {
          let result = try api.pigeonDelegate.getSymbologies(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getSymbologiesChannel.setMessageHandler(nil)
    }
    let setSymbologiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNDetectBarcodesRequestProxyApi.setSymbologies", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setSymbologiesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNDetectBarcodesRequest
        let valueArg = args[1] as! [VNBarcodeSymbologyApi]
        do {
          try api.pigeonDelegate.setSymbologies(pigeonApi: api, pigeonInstance: pigeonInstanceArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setSymbologiesChannel.setMessageHandler(nil)
    }
    let getResultsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNDetectBarcodesRequestProxyApi.getResults", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getResultsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNDetectBarcodesRequest
  ...
  ///Creates a Dart instance of VNDetectBarcodesRequestProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNDetectBarcodesRequest, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      completion(
        .failure(
          CameraXError(
            code: "new-instance-error",
            message: "Error: Attempting to create a new Dart instance of VNDetectBarcodesRequestProxyApi, but the class has a nonnull callback method.", details: "")))
    }
  }
}
protocol PigeonApiDelegateVNBarcodeObservationProxyApi {
...
protocol PigeonApiProtocolVNBarcodeObservationProxyApi {
}

final class PigeonApiVNBarcodeObservationProxyApi: PigeonApiProtocolVNBarcodeObservationProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNBarcodeObservationProxyApi
  ///An implementation of [VNRectangleObservationProxyApi] used to access callback methods
  var pigeonApiVNRectangleObservationProxyApi: PigeonApiVNRectangleObservationProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVNRectangleObservationProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNBarcodeObservationProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNBarcodeObservationProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getPayloadStringValueChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNBarcodeObservationProxyApi.getPayloadStringValue", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getPayloadStringValueChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNBarcodeObservation
        do {
          let result = try api.pigeonDelegate.getPayloadStringValue(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getPayloadStringValueChannel.setMessageHandler(nil)
    }
    let getSymbologyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNBarcodeObservationProxyApi.getSymbology", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSymbologyChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNBarcodeObservation
        do {
          let result = try api.pigeonDelegate.getSymbology(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getSymbologyChannel.setMessageHandler(nil)
    }
  }

  ///Creates a Dart instance of VNBarcodeObservationProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNBarcodeObservation, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNBarcodeObservationProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVNDetectFaceRectanglesRequestProxyApi {
...
protocol PigeonApiProtocolVNDetectFaceRectanglesRequestProxyApi {
}

final class PigeonApiVNDetectFaceRectanglesRequestProxyApi: PigeonApiProtocolVNDetectFaceRectanglesRequestProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNDetectFaceRectanglesRequestProxyApi
  ///An implementation of [VNImageBasedRequestProxyApi] used to access callback methods
  var pigeonApiVNImageBasedRequestProxyApi: PigeonApiVNImageBasedRequestProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVNImageBasedRequestProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNDetectFaceRectanglesRequestProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNDetectFaceRectanglesRequestProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNDetectFaceRectanglesRequestProxyApi.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
...
withIdentifier: pigeonIdentifierArg)
    ...
    let getResultsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNDetectFaceRectanglesRequestProxyApi.getResults", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getResultsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNDetectFaceRectanglesRequest
        do {
          let result = try api.pigeonDelegate.getResults(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
  ...
  ///Creates a Dart instance of VNDetectFaceRectanglesRequestProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNDetectFaceRectanglesRequest, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      completion(
        .failure(
          CameraXError(
            code: "new-instance-error",
            message: "Error: Attempting to create a new Dart instance of VNDetectFaceRectanglesRequestProxyApi, but the class has a nonnull callback method.", details: "")))
    }
  }
}
protocol PigeonApiDelegateVNFaceLandmarkRegionProxyApi {
  func getPointCount(pigeonApi: PigeonApiVNFaceLandmarkRegionProxyApi, pigeonInstance: VNFaceLandmarkRegion) throws -> Int64
}

protocol PigeonApiProtocolVNFaceLandmarkRegionProxyApi {
}

final class PigeonApiVNFaceLandmarkRegionProxyApi: PigeonApiProtocolVNFaceLandmarkRegionProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNFaceLandmarkRegionProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNFaceLandmarkRegionProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNFaceLandmarkRegionProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getPointCountChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarkRegionProxyApi.getPointCount", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getPointCountChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarkRegion
        do {
          let result = try api.pigeonDelegate.getPointCount(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getPointCountChannel.setMessageHandler(nil)
    }
  }

  ///Creates a Dart instance of VNFaceLandmarkRegionProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNFaceLandmarkRegion, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNFaceLandmarkRegionProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVNFaceLandmarkRegion2DProxyApi {
...
protocol PigeonApiProtocolVNFaceLandmarkRegion2DProxyApi {
}

final class PigeonApiVNFaceLandmarkRegion2DProxyApi: PigeonApiProtocolVNFaceLandmarkRegion2DProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNFaceLandmarkRegion2DProxyApi
  ///An implementation of [VNFaceLandmarkRegionProxyApi] used to access callback methods
  var pigeonApiVNFaceLandmarkRegionProxyApi: PigeonApiVNFaceLandmarkRegionProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVNFaceLandmarkRegionProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNFaceLandmarkRegion2DProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNFaceLandmarkRegion2DProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getNormalizedPointsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarkRegion2DProxyApi.getNormalizedPoints", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getNormalizedPointsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarkRegion2D
        do {
          let result = try api.pigeonDelegate.getNormalizedPoints(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getNormalizedPointsChannel.setMessageHandler(nil)
    }
    let getPrecisionEstimatesPerPointChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarkRegion2DProxyApi.getPrecisionEstimatesPerPoint", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getPrecisionEstimatesPerPointChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarkRegion2D
        do {
          let result = try api.pigeonDelegate.getPrecisionEstimatesPerPoint(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getPrecisionEstimatesPerPointChannel.setMessageHandler(nil)
    }
    let pointsInImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarkRegion2DProxyApi.pointsInImage", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pointsInImageChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarkRegion2D
        let imageSizeArg = args[1] as! Size
        do {
          let result = try api.pigeonDelegate.pointsInImage(pigeonApi: api, pigeonInstance: pigeonInstanceArg, imageSize: imageSizeArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      pointsInImageChannel.setMessageHandler(nil)
    }
  }

  ///Creates a Dart instance of VNFaceLandmarkRegion2DProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNFaceLandmarkRegion2D, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNFaceLandmarkRegion2DProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVNFaceLandmarksProxyApi {
  func getConfidence(pigeonApi: PigeonApiVNFaceLandmarksProxyApi, pigeonInstance: VNFaceLandmarks) throws -> Double
}

protocol PigeonApiProtocolVNFaceLandmarksProxyApi {
}

final class PigeonApiVNFaceLandmarksProxyApi: PigeonApiProtocolVNFaceLandmarksProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNFaceLandmarksProxyApi
  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNFaceLandmarksProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNFaceLandmarksProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getConfidenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarksProxyApi.getConfidence", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getConfidenceChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks
        do {
          let result = try api.pigeonDelegate.getConfidence(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
  ...
  ///Creates a Dart instance of VNFaceLandmarksProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNFaceLandmarks, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNFaceLandmarksProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVNFaceLandmarks2DProxyApi {
...
protocol PigeonApiProtocolVNFaceLandmarks2DProxyApi {
}

final class PigeonApiVNFaceLandmarks2DProxyApi: PigeonApiProtocolVNFaceLandmarks2DProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNFaceLandmarks2DProxyApi
  ///An implementation of [VNFaceLandmarksProxyApi] used to access callback methods
  var pigeonApiVNFaceLandmarksProxyApi: PigeonApiVNFaceLandmarksProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVNFaceLandmarksProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNFaceLandmarks2DProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNFaceLandmarks2DProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getAllPointsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getAllPoints", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getAllPointsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getAllPoints(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getAllPointsChannel.setMessageHandler(nil)
    }
    let getFaceContourChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getFaceContour", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getFaceContourChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getFaceContour(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getFaceContourChannel.setMessageHandler(nil)
    }
    let getLeftEyeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getLeftEye", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getLeftEyeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getLeftEye(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getLeftEyeChannel.setMessageHandler(nil)
    }
    let getRightEyeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getRightEye", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getRightEyeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getRightEye(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getRightEyeChannel.setMessageHandler(nil)
    }
    let getLeftEyebrowChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getLeftEyebrow", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getLeftEyebrowChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getLeftEyebrow(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getLeftEyebrowChannel.setMessageHandler(nil)
    }
    let getRightEyebrowChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getRightEyebrow", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getRightEyebrowChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getRightEyebrow(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getRightEyebrowChannel.setMessageHandler(nil)
    }
    let getNoseChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getNose", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getNoseChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getNose(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getNoseChannel.setMessageHandler(nil)
    }
    let getNoseCrestChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getNoseCrest", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getNoseCrestChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getNoseCrest(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getNoseCrestChannel.setMessageHandler(nil)
    }
    let getMedianLineChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getMedianLine", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMedianLineChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getMedianLine(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getMedianLineChannel.setMessageHandler(nil)
    }
    let getOuterLipsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getOuterLips", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getOuterLipsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getOuterLips(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getOuterLipsChannel.setMessageHandler(nil)
    }
    let getInnerLipsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getInnerLips", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getInnerLipsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getInnerLips(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getInnerLipsChannel.setMessageHandler(nil)
    }
    let getLeftPupilChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getLeftPupil", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getLeftPupilChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getLeftPupil(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getLeftPupilChannel.setMessageHandler(nil)
    }
    let getRightPupilChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.getRightPupil", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getRightPupilChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceLandmarks2D
        do {
          let result = try api.pigeonDelegate.getRightPupil(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getRightPupilChannel.setMessageHandler(nil)
    }
  }

  ///Creates a Dart instance of VNFaceLandmarks2DProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNFaceLandmarks2D, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNFaceLandmarks2DProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol PigeonApiDelegateVNFaceObservationProxyApi {
...
protocol PigeonApiProtocolVNFaceObservationProxyApi {
}

final class PigeonApiVNFaceObservationProxyApi: PigeonApiProtocolVNFaceObservationProxyApi  {
  unowned let pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateVNFaceObservationProxyApi
  ///An implementation of [VNDetectedObjectObservationProxyApi] used to access callback methods
  var pigeonApiVNDetectedObjectObservationProxyApi: PigeonApiVNDetectedObjectObservationProxyApi {
    return pigeonRegistrar.apiDelegate.pigeonApiVNDetectedObjectObservationProxyApi(pigeonRegistrar)
  }

  init(pigeonRegistrar: CameraXApiPigeonProxyApiRegistrar, delegate: PigeonApiDelegateVNFaceObservationProxyApi) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiVNFaceObservationProxyApi?) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: CameraXApiPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let getLandmarksChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceObservationProxyApi.getLandmarks", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getLandmarksChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceObservation
        do {
          let result = try api.pigeonDelegate.getLandmarks(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getLandmarksChannel.setMessageHandler(nil)
    }
    let getRollChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceObservationProxyApi.getRoll", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getRollChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceObservation
        do {
          let result = try api.pigeonDelegate.getRoll(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getRollChannel.setMessageHandler(nil)
    }
    let getYawChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceObservationProxyApi.getYaw", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getYawChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceObservation
        do {
          let result = try api.pigeonDelegate.getYaw(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getYawChannel.setMessageHandler(nil)
    }
    let getPitchChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camerax_ios.VNFaceObservationProxyApi.getPitch", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getPitchChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! VNFaceObservation
        do {
          let result = try api.pigeonDelegate.getPitch(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getPitchChannel.setMessageHandler(nil)
    }
  }

  ///Creates a Dart instance of VNFaceObservationProxyApi and attaches it to [pigeonInstance].
  func pigeonNewInstance(pigeonInstance: VNFaceObservation, completion: @escaping (Result<Void, CameraXError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          CameraXError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.camerax_ios.VNFaceObservationProxyApi.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
