...
enum AVCaptureDeviceCinematicVideoFocusModeApi: Int {
  case none = 0
  case strong = 1
  case weak = 2
}
...
enum VideoRecordEventFinalizeErrorApi: Int {
  case none = 0
  case unknown = 1
